...
type SessionID = cardpipeline.SessionID
type Purpose = cardpipeline.Purpose

const (
	PurposeTransfer = cardpipeline.PurposeTransfer
	PurposeEdit     = cardpipeline.PurposeEdit
)
...
type FileID = cardpipeline.FileID
